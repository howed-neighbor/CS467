module.exports = function() {
	...
	router.post("/", (req,res) => {
		...
		if (req.body.type == "default") { 
			// selectUserName(res,mysql,context,loaded,"UsersHardened");	// Vulnerable function access removed
			loaded()
			}
		else if (req.body.type == "remediation") { 
			selectUserNameRemediation(res,mysql,context,loaded,"UsersHardened");
			}
